...
export default function PortfolioPage() {
  ...
  useEffect(() => {
    ...
    const imageGallerySchema = {
      ...
      "description": "다양한 행사와 이벤트에서 선보인 케이터링 서비스",
    ...
    if (metaDescription) {
      metaDescription.setAttribute('content', '다양한 행사와 이벤트에서 선보인 케이터링 서비스를 만나보세요. 기업 미팅, 웨딩, 파티 등 다양한 케이터링 포트폴리오를 확인하세요.');
    }
      ...
      <section className="relative pt-32 pb-20 bg-gradient-to-br from-pink-100 via-purple-100 to-blue-100">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-700 max-w-3xl mx-auto">
            다양한 행사와 이벤트에서 선보인 케이터링 서비스를 만나보세요
          </p>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {!loading && filteredPortfolio.length === 0 && (
            <div className="text-center py-20">
              ...
              <p className="text-xl text-gray-500">해당하는 포트폴리오가 없습니다</p>
            </div>
          )}
        </div>
      </section>
