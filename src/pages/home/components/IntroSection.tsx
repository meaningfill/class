    ...
    >
      ...
      <div className="absolute inset-0 opacity-30">
        <div className="absolute inset-0" style={{
          backgroundImage: 'radial-gradient(circle at 2px 2px, rgba(167, 139, 250, 0.2) 1px, transparent 0)',
      ...
      {/* Decorative Hearts */}
      <div className="absolute top-40 right-20 text-pink-300/20 text-6xl animate-bounce" style={{ animationDelay: '0.5s' }}>
        <i className="ri-heart-fill"></i>
      </div>
      <div className="absolute bottom-40 left-20 text-purple-300/20 text-5xl animate-bounce" style={{ animationDelay: '1.5s' }}>
        <i className="ri-heart-fill"></i>
      </div>
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6">
        ...
        <div className="text-center mb-16 sm:mb-20">
          ...
          <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-black text-slate-900 mb-2 leading-tight px-4">
            단순한 레시피가 아니라
            <br />
          ...
          {features.map((feature, index) => (
            ...
            >
              ...
              <div className="relative mb-6 flex justify-center">
                <div className={`w-20 h-20 flex items-center justify-center bg-gradient-to-br ${feature.gradient} rounded-2xl shadow-lg group-hover:scale-110 group-hover:rotate-6 transition-all duration-500`}>
